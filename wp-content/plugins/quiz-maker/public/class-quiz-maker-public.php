...
class Quiz_Maker_Public
{
    ...
    /*******************************************************************************************************/ 
        ...
        // Image Width(px)
        $image_width = (isset($options['image_width']) && sanitize_text_field($options['image_width']) != '' && sanitize_text_field($options['image_width']) != 0) ? absint( sanitize_text_field($options['image_width']) ) : '';
