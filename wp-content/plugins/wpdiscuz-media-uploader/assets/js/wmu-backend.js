jQuery(document).ready(function ($) {
    ...
    $(document).delegate('#wmu-regenerate-metakeys', 'click', function (e) {
        var btn = $(this);
    ...
    $(document).delegate('.wpd-settings-tab_' + wmuJsObj.wmuTabSlug + ' form', 'submit', function () {
        $('[data-wpd-opt=wmuCustomMimeTypes] .wpd-custom-option-group.wpd-custom-option-group-default').remove();
    });
    $(document).delegate('[data-wpd-opt=wmuCustomMimeTypes] .wpd-custom-option-group-add', 'click', function () {
    ...
    $(document).delegate('[data-wpd-opt=wmuCustomMimeTypes] .wpd-custom-option-group .dashicons.dashicons-trash', 'click', function () {
    ...
    $(document).delegate('.import-dco', 'click', function (e) {
        e.preventDefault();
        var btn = $(this);
        btn.attr('disabled', 'disabled');
        $('.fas', btn).addClass('fa-pulse fa-spinner').removeClass('wc-hidden');
