...
<p style="padding: 30px 0px; font-size: 24px; line-height: 40px; text-align: left;"><span style="display: block;">Dear <strong>{username}</strong>, <br />You have successfully registered for the Climate Box application . Your registered account has been activated by the admin. Please login to the application with valid credentials or Click on the below Activation link.</span></p>
