									...
									if ( in_array( 'um_teacher', (array) $user->roles ) ) { ?>
										...
										<?php if ( 'publish' === get_post_status() ) { ?>
											<div class="head_action">
													...
													$submit_question = pll_get_post( 813 );
													$submit_question_url = get_the_permalink($submit_question);
													?>
													<a class="btn btnBlue" href="<?php echo $submit_question_url; ?>"><?php pll_e('Submit Question'); ?></a>
												</div>
											<?php } ?>
