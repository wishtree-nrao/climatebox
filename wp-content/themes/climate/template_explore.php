<?php /* Template Name: Explore Page */ 
					...
					<div class="row">
						<div class="col-sm-12 col-md-8 col-lg-9">
							...
							<div class="tab-content" id="ExploreTabContent">
								<div class="tab-pane fade show active" id="ExploreTabNews" role="tabpanel" aria-labelledby="ExploreTabNews-tab">
									...
									?>
									<form class="search_small" method="get" action="<?php echo home_url($wp->request); ?>">
										...
										<div class="row">
											<?php while ( $loop->have_posts() ) : $loop->the_post();  ?>
												<div class="col-sm-6 col-md-6 col-lg-4">
													<div class="post_litem pi_news w4post">
